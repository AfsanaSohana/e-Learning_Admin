...
function CertificateApplyRequestAdd() {
    const [inputs, setInputs] = useState({id:'',student_id:'',batch_id:'',course_id:'',enroll_date:'',trans_id:''});
    const [batch, setBatch] = useState([]);
    const [batchEnroll, setbatchEnroll] = useState([]);
    ...
    function getDatas(){
        axios.get(`${process.env.REACT_APP_API_URL}/certificate_en_req/${id}`).then(function(response) {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            let apiurl = '';
            if(inputs.id !== ''){
                apiurl = `/certificate_en_req/edit/${inputs.id}`;
            } else {
                apiurl = `/certificate_en_req/create`;
            }
            ...
            navigate('/certificateApplyRequest');
        } 
        catch(e) {
            console.log(e);
        }
                ...
                <div className="page-title">
                    <div className="row">
                        <div className="col-12 col-md-6 order-md-1 order-last">
                            <h3>Add New CertificateApplyRequest</h3>
                        </div>
...
export default CertificateApplyRequestAdd;
